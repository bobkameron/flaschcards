...
class Card (models.Model):
    ...
    5 * seconds_per_hour, 1 * seconds_per_day, 5 * seconds_per_day, 25 * seconds_per_day, seconds_per_month]
    ...
    datetime_to_next_appearance = models.DateTimeField (auto_now_add = True , null = False )
